...
convert "${TS_BASE}" \
    ...
    \
    -annotate +1645+1570 "$TS_OUT_SU" \
    -annotate +1645+1695 "$TS_OUT_MO" \
    -annotate +1645+1820 "$TS_OUT_TU" \
    -annotate +1645+1935 "$TS_OUT_WE" \
    -annotate +1645+2060 "$TS_OUT_TH" \
    -annotate +1645+2185 "$TS_OUT_FR" \
    -annotate +1645+2300 "$TS_OUT_SA" \
    \
